...
import type { ProfileFollowers, ProfileFollowing, ProfileInfo, ProfilePosts } from "@/shared/types/ApiTypes/ProfileApiTypes"
...
export const UserInfo = ({ profile, isProfileOwner, posts, followers, following }: Props) => {
