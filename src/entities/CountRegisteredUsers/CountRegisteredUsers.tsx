...
const CountRegisteredUsers = ({ count }: CountRegisteredUsersProps) => {
  ...
  return (
    <div className="flex w-full justify-center flex-col md:flex-row md:justify-between flex-wrap items-center bg-dark-500 py-[12px] px-[24px]  border border-dark-300 rounded-sm">
