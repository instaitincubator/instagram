...
const GeneralInformation = () => {
  ...
  return (
    <div className="flex flex-col w-full justify-center pb-[15px] md:pb-0 items-stretch sm:items-start  md:flex-row md:self-start md:pl-[24px]  md:pr-[64px] md:w-full md:gap-10">
